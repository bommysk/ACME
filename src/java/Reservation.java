...
public class Reservation implements Serializable {
    ...
    public String createReservation() throws SQLException {
        ...
        PreparedStatement preparedStatement = con.prepareStatement("insert into reservation(customer_id, room_number, start_date, end_date) values((select id from customer where login = ?),?,?,?)");
